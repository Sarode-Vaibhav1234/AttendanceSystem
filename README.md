This is an Android application named **Presenza** which is a biometric-based attendance management system designed to streamline and secure the process of marking and tracking student attendance. 
Developed as an Android application with a MySQL backend, Presenza caters to both students and teachers through dedicated login modules. 
By integrating fingerprint authentication and time-based attendance announcements, the system ensures accurate and tamper-proof attendance records.
