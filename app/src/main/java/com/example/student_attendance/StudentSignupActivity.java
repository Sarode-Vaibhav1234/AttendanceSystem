...
public class StudentSignupActivity extends AppCompatActivity {
    ...
    private void checkIfDeviceRegistered() {
        ...
        String url = "http://192.168.35.247/phpProject/check_registration.php";  // Check registration endpoint
    ...
    private void registerStudent() {
        ...
        String url = "http://192.168.35.247/phpProject/student_signup.php";  // Register student endpoint
